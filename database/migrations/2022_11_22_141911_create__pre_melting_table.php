...
class CreatePreMeltingTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('lhp_melting', function (Blueprint $table) {
            ...
            $table->decimal('persen_fluxing', $precision = 8, $scale = 2)->default('0');
            $table->decimal('persen_ingot', $precision = 8, $scale = 2)->default('0');
            $table->decimal('persen_rs', $precision = 8, $scale = 2)->default('0');
            ...
            $table->decimal('persen_losdros_material', $precision = 8, $scale = 2)->default('0');
            $table->decimal('persen_alm_treat', $precision = 8, $scale = 2)->default('0');
            $table->decimal('machine_performance', $precision = 8, $scale = 2)->default('0');
            $table->decimal('machine_utilization', $precision = 8, $scale = 2)->default('0');
            $table->integer('gas_akhir')->default('0');
            $table->decimal('gas_consum', $precision = 8, $scale = 2)->default('0');
