        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="row justify-content-end text-end  ">
                    <div class="col-5 filter-dtl">
                        <form action="{{ url('/production/melting/' . $mesin) }}" method="post">
                            @csrf
                            <input type="date" id="start" name="start" value="{{ $mulai }}"
                                class="inpt-date border border-3 rounded">
                            &ensp; s/d &ensp;
                            <input type="date" id="end" name="end" value="{{ $selesai }}"
                                class="inpt-date border border-3 rounded">
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" id="hourlyclose" data-bs-dismiss="modal"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="" name="ingot"
                                                id="ingot" required>
                                        </div>
                                        <div class="col">
                                            <label for="exgate">EXGATE</label>
                                            <input type="text" class="form-control" name="exgate" id="exgate"
                                                required>
                                        </div>
                                        <div class="col">
                                            <label for="reject_parts">PARTS NG</label>
                                            <input type="text" class="form-control" name="reject_parts"
                                                id="reject_parts" required>
                                        </div>
                                        <div class="col">
                                            <label for="tapping">TAPPING</label>
                                            <input type="text" class="form-control" name="tapping" id="tapping"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="alm_treat" id="alm_treat"
                                                required>
                                        </div>
                                        <div class="col">
                                            <label for="fluxing">FLUXING</label>
                                            <input type="text" class="form-control" name="fluxing" id="fluxing"
                                                required>
                                        </div>
                                        <div class="col">
                                            <label for="dross">DROSS</label>
                                            <input type="text" class="form-control" name="dross" id="dross"
                                                required>
                                        </div>
                                        {{-- <div class="col">
