    ...
    <body class="body">
        <div class="container-fluid conflu">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row mt-3">
                        <div class="col-9 mt-3 mb-2 nama"> 
                    ...
                    @if($running != null) 
                        <div class="row mt-5 mb-2"> 
                            <div class="downtime shadow mt-3 "> DOWNTIME - {{$downtime}}</div>
                        </div>
                    @else 
                        <div class="row mt-5 mb-2"> 
                            <div class="running  mt-3 "> RUNNING </div>
                        </div>
                    @endif
                    ...
                    <div class="row ">
                        ...
                        @elseif($prep == 3)
                            <div class="col-4 mt-4 d-flex ">
                                ...
                                <div class="row prep3">
                                    ...
                                    <div id="henkaten3c" class="col-10 mb-4 machine3 ">{{ $isi3c }}</div>
                                </div>
                            </div>
                        ...
                        <div class="col-8 mb-2">
                            <div class="row mt-4 mb-1"> 
                                <div class="col-3 mt-2 pt-2 text-center m-auto availa"> AVA</div>
                ...
                <div class="col-6">
                    ...
                    <div class="row atas mt-4 mb-1">
                            <div class="col-4 aktual">
                                <div class="text-center rounded-0">
                                    <div class="penjelasan box">AKTUAL</div>
                                    <div class="angka">{{ $aktual2 }}</div>
                                </div>
                            </div>
                            <div class="col-4 target">
                                <div class="text-center rounded-0">
                                    <div class="penjelasan box">TARGET</div>
                                    <div class="angka">{{ $target2 }}</div>
                                </div>
                            </div>
                            ...
                            <div class="col-4 text-center parent ">
                                <div class="parallelogram boxperform child">
                                    ...
                                    @else
                                        <h1 style="font-size: 30px; margin-top: -50px">
                                            <span class="persen2">{{ $persen2 }}</span>
                                            <span class="symbol">%</span>
                                        </h1>
                                    @endif
                    ...
                    <div class="row ">
                        ...
                        @if($prep2 == 1 )
                            <div class="col-4 mt-4 d-flex">
                                ...
                                <div id="henkaten1" class="col-10 manpower1">{{ $isi5 }} </div>
                        ...
                        @elseif($prep2 == 2)
                            <div class="col-4 mt-4 d-flex ">
                                 <div class="col-2 henkaten2">
                                    ...
                                    <div class="row prep2">
                                        <div id="henkaten2a" class="col-10 manpower2">{{ $isi6a }}</div>
                                        <div id="henkaten2b" class="col-10 mb-4 method2">{{ $isi6b }}</div>
                                    </div>
                            </div>
                        ...
                        @elseif($prep2 == 3)
                            <div class="col-4 mt-4 d-flex ">
                                ...
                                <div class="row prep3">
                                    <div id="henkaten3a" class="col-10 manpower3 ">{{ $isi7a }}</div>
                                    <div id="henkaten3b" class="col-10 method3 ">{{ $isi7b }}</div>
                                    <div id="henkaten3c" class="col-10 mb-4 machine3 ">{{ $isi7c }}</div>
                                </div>
                            </div>
                        ...
                        @elseif($prep2 == 4)
                            <div class="col-4 mt-3 d-flex ">
                                ...
                                <div class="row">
                                    <div class="col-10 manpower4 ">{{ $isi8a }}</div>
                                    <div class="col-10 method4 ">{{ $isi8b }}</div>
                                    <div class="col-10 machine4 ">{{ $is8c }}</div>
                                    <div class="col-10 material4 border">{{ $isi8d }}</div>
                                </div>
                            </div>
