    ...
    <div class="row">
      <div class="col-6">
        <div class="row ba">
          ...
          <form action="/submit" method="post" class="form-item">
            @csrf
            Deskripsi :
            <div class="Deskripsi">
        ...
        <div class="container overflow-hidden text-center">
          <div class="row gx-5">
            <div class="form-check d-flex" role="group" aria-label="Basic example">
              ...
              <div class="form check-form-check-inline col-2 px-3 py-4 d-flex ">
                <input class="radio form-check input mx-3 big" type="radio" id="Job_Setup" name="Job_Setup" value="yes">
                <label class="from-check-label py-1" for="open">yes</label>
              </div>
              <div class="form-check form-check-inline col-3 px-3 py-4 d-flex">
                <input class="radio form-check input mx-3 big" type="radio" id="Job_Setup" name="Job_Setup" value="no">
                <label class="form-check-label py-1" for="close">no</label>
                <!-- <button type="button" class="btn btn-secondary">Right</button> -->
              </div>
            </div>
        ...
        <div class="container overflow-hidden text-center">
          <div class="row gx-5">
            <div class="form-check d-flex" role="group" aria-label="Basic example">
              ...
              <div class="form check-form-check-inline col-2 px-3 py-4 d-flex ">
                <input class="radio form-check input mx-3 big" type="radio" id="Trial_NS" name="Trial_NS" value="yes">
                <label class="from-check-label py-1" for="open">yes</label>
              </div>
              <div class="form-check form-check-inline col-3 px-3 py-4 d-flex">
                <input class="radio form-check input mx-3 big" type="radio" id="Trial_NS" name="Trial_NS" value="no">
                <label class="form-check-label py-1" for="close">no</label>
                <!-- <button type="button" class="btn btn-secondary">Right</button> -->
              </div>
            </div>
        ...
        <div class="container overflow-hidden text-center">
          <div class="row gx-5">
            <div class="form-check d-flex" role="group" aria-label="Basic example">
              ...
              <div class="form check-form-check-inline col-2 px-3 py-4 d-flex ">
                <input class="radio form-check input mx-3 big" type="radio" id="Trial_Proses" name="Trial_Proses" value="yes">
                <label class="from-check-label py-1" for="open">yes</label>
              </div>
              <div class="form-check form-check-inline col-3 px-3 py-4 d-flex">
                <input class="radio form-check input mx-3 big" type="radio" id="Trial_Proses" name="Trial_Proses" value="no">
                <label class="form-check-label py-1" for="close">no</label>
                <!-- <button type="button" class="btn btn-secondary">Right</button> -->
              </div>
            </div>
    ...
    <table class="table table-bordered table-responsive">
      <thead class="table-light">
        <tr>
          ...
          <th nowrap="nowrap">Job Set Up</th>
          <th nowrap="nowrap">Trial NS</th>
          <th nowrap="nowrap">CP CPK</th>
          <th nowrap="nowrap" wrap="nowrap">Trial Proses</th>
        </tr>
      </thead>
      <tbody>
        @php
        ...
        <tr>
          ...
          <td>{{$item->Trial_NS}}</td>
          <td>{{$item->CP_CPK}}</td>
          <td>{{$item->Trial_Proses}}</td>
          <td>
            <a href='/edit/{{$item->No}}'><button type="button" class="btn btn-primary">Edit</button></a>
          </td>
          <td>
            <a href='/material_delete/{{$item->No}}'><button type="button" class="btn btn-danger">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
