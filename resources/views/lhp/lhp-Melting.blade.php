        ...
        <form action="{{ url('/lhp-melting/' . $mesin . '/' . $id . '/simpan') }}" method="POST">
            ...
            <div class="row mt-3">
                <div class="col-8">
                    <div class="card card_form_input">
                        <div class="card-body">
                            <input type="number" max="99999999999" class="fw-bold text-end input_berat" name="berat"
                                id="berat" placeholder="Masukkan Angka..." autofocus required>
                        </div>
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                <div class="col-8 mt-3">
                    <div class="card cacard-material">
                        <div class="card-body">
        ...
        $(function() {
            ...
            socket.on(lokasi, (data) => {
                if (data.length == 0) {
                    ...
                    document.getElementById("stok_molten").innerHTML = data[0].stok_molten.toLocaleString(
                        'de-DE') + " KG";
                }
            })
        });
